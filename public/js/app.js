...
/* harmony import */ var _singleOrder__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./singleOrder */ "./resources/js/singleOrder.js");
/* harmony import */ var _total__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./total */ "./resources/js/total.js");
/* harmony import */ var _archiv__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./archiv */ "./resources/js/archiv.js");
...
Object(_singleOrder__WEBPACK_IMPORTED_MODULE_5__["initSingleOrder"])();
Object(_total__WEBPACK_IMPORTED_MODULE_6__["initTotal"])();
Object(_archiv__WEBPACK_IMPORTED_MODULE_7__["initArchiv"])(); // Change order status
...
function initSingleOrder() {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function generateMarkup(orders) {
      var qrCode = ''; // define qrCode variable before calling QRCode.toDataURL

      return orders.map(function (order) {
        qrcode__WEBPACK_IMPORTED_MODULE_1___default.a.toDataURL(url, function (err, dataURI) {
          if (err) throw err;
          qrCode = "<img src=\"".concat(dataURI, "\" />"); // assign the value of dataURI to qrCode
        });
    ...
    function renderItems(items) {
      var parsedItems = Object.values(items);
      return parsedItems.map(function (menuItem) {
        return "\n          <div class=\"flex items-center mb-2\">\n            <p class=\"mr-2\">".concat(menuItem.item.name, "</p>\n            <input\n              type=\"number\"\n              class=\"quantity-input\"\n              value=\"").concat(menuItem.qty, "\"\n              data-order-id=\"").concat(orderId, "\"\n              data-item-id=\"").concat(menuItem.item._id, "\"\n            />\n          </div>\n        ");
      }).join('');
    }
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51JlxjKIsIcjwovkaVR6ZmlU1la0EtSl3yONoKLyLOg5EN3uQAboOdkayMglCHtoGv8T7uqJo38Vwrz2WBwGxL3F3001vhfe8l5');
